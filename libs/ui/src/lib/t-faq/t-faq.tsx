...
//     color: #8e8e8e;
//     position: relative;
//     display: inline-block; /* Ensures the text doesn't stretch the line */
//   }

//   /* Horizontal Line After the FAQ Text */
//   .faq-line-container {
//     display: flex;
//     align-items: center;
//     margin-bottom: 20px;
...
//     background-color: #8e8e8e; /* Blue color for the line */
...
//     margin-bottom: 1rem;
//     padding: 10px 0;
//     border-bottom: 1px solid #ccc; /* Single line below each FAQ */
...
//       answer: "Yes, we offer a variety of vegan options. Check our menu for details.",
//     },
//     {
...
//         <h2>FAQ's</h2>
//         <div className="faq-line"></div> {/* Horizontal line */}
//       </div>
//       {faqs.map((faq, index) => (
//         <div
